...
<main class="container d-flex justifu-content-center">
    <div class="card">
        <form action="/management/update" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="card-text">Email: <input type="text" name="em_email" value=<?php echo $employee['em_email'] ?>></div>
                <div class="card-text">Password : <input type="text" name="em_password" value=<?php echo $employee['em_password'] ?>></div>
